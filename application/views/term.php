    ...
    <div class="content-wrapper">
        <div class="content-header">
            ...
            <div class="card-body">
                ...
                <button type="submit" id="addTerms" class="common-btn-padding btn btn-success "> Save </button>
...
<script>
    ClassicEditor
        ...
        .then(editor => {
            ...
            let htmlContent = localStorage.getItem("termsContent");
            if (htmlContent) {
            ...
            editor.model.document.on('change:data', () => {
                ...
                localStorage.setItem("termsContent", htmlContent);
            });
